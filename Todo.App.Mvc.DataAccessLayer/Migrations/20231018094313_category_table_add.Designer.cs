...
namespace Todo.App.Mvc.DataAccessLayer.Migrations
{
    ...
    [Migration("20231018094313_category_table_add")]
    partial class category_table_add
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDo.App.Mvc.EntityLayer.Concrete.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ToDo.App.Mvc.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ToDo.App.Mvc.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ToDo.App.Mvc.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
